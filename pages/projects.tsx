    ...
    >
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16 w-full">
        ...
        <div className="pt-16 w-full flex justify-center">
          <a
            className="bg-primary rounded-lg flex items-center justify-center text-white text-base font-semibold transition hover:scale-105 duration-300 px-12 py-4"
